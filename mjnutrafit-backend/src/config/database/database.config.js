...
// Database configuration - supports both DATABASE_URL and individual components
let databaseConfig = {};

if (process.env.DATABASE_URL) {
  // Parse PostgreSQL connection string (e.g., from Neon)
  ...
  // Use individual environment variables (like HandyHub)
  databaseConfig = {

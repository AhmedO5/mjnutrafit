      ...
      <section className="container mx-auto px-4 py-20 md:py-32 flex-1">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-muted-foreground mb-12 max-w-2xl mx-auto leading-relaxed">
            Get personalized diet and workout plans from certified coaches. Track your progress weekly. 
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          <Card className="border-2 hover:border-primary/50 transition-all duration-300 hover:shadow-elevated">
            <CardHeader>
              ...
              <CardDescription className="text-base">
                Weekly logging with visual trends and insights
              </CardDescription>
            </CardHeader>
            <CardContent>
              <p className="text-muted-foreground">
                Log your weight, meal adherence, and workout completion weekly. See your progress 
                over time with beautiful charts and trends.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="border-2 hover:border-primary/50 transition-all duration-300 hover:shadow-elevated">
            ...
            <CardContent>
              <p className="text-muted-foreground">
                Submit your weekly progress and receive detailed feedback from your assigned coach. 
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-muted-foreground">
                Log your weekly progress: weight, meals, and workouts
              </p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 rounded-full bg-primary text-primary-foreground flex items-center justify-center text-2xl font-bold mx-auto mb-4">
